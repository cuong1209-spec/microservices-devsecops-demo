...
+--------------------------------------+------+------------------+---------+
| demo-app/order-service/requirements  | pip  |        1         |         |
| demo-app/order-service/app.py        | text |                  |    1    |
+--------------------------------------+------+------------------+---------+

demo-app/order-service/requirements.txt (pip)
Total: 1 (HIGH: 1, CRITICAL: 0)
+-----------+-----------------+----------+-----------+----------------------------+
| Library   | Vulnerability   | Severity | Installed | Title                      |
|           |                 |          | Version   |                            |
+-----------+-----------------+----------+-----------+----------------------------+
| werkzeug  | CVE-2024-34069  | HIGH     | 2.2.3     | User may execute code on a |
|           |                 | (fixed)  | -> 3.0.3  | developer's machine        |
+-----------+-----------------+----------+-----------+----------------------------+

demo-app/order-service/app.py (secrets)
Total: 1 (HIGH: 0, CRITICAL: 1)
CRITICAL: Stripe (stripe-secret-token)
  Stripe Secret Key detected at line 12
  12| STRIPE_API_KEY = "****************************"
\end{lstlisting}
